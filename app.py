    ...
    with st.spinner("シミュレーション実行中..."):
        ...
        for data in stats_data:
            ...
            if enable_crash:
                crash_info = {
                    "経過年数": data["経過年数"],
                    "上位5%の暴落経験率": data["暴落(上位5%)"],
                    "上位5-25%の暴落経験率": data["暴落(75-95%)"],
                    "上位25-50%の暴落経験率": data["暴落(50-75%)"],
                    "下位50-25%の暴落経験率": data["暴落(25-50%)"],
                    "下位25-5%の暴落経験率": data["暴落(5-25%)"],
                    "下位5%の暴落経験率": data["暴落(下位5%)"]
                }
